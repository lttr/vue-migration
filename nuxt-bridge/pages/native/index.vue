<template>
  <div class="patterns">
    ...
    <section>
      ...
      <p><code>@click.native</code> - native DOM listener in Vue 2</p>
      <ChildButton @click.native="log('explicit', '@click.native fired')" />
    </section>

    <section>
      <h2>2. Hidden behavior</h2>
      <p><code>@click</code> on component that doesn't emit - silent in Vue 2, fires in Vue 3</p>
      <SilentChild @click="log('hidden', '@click fired (should NOT see in Vue 2)')" />
    </section>
